...
class Crawler:
    ...
    def load_details(self, course_info: dict) -> dict:
        ...
        url = url_base.format(dept_code=5722, course_no=course_info["course_no"], course_class=course_info["course_class"])
        page = requests.get(url)
        soup = BeautifulSoup(page.content, 'html.parser')
        
        course_intro = soup.select_one("body > div > div.page > form:nth-child(1) > div.bottom_view > table:nth-child(3) > tbody > tr:nth-child(2) > td").text
        ...
        prereq_1 = soup.select_one("body > div > div.page > form:nth-child(1) > table:nth-child(29) > tbody > tr:nth-child(2) > td").text   
        prereq_2 = soup.select_one("body > div > div.page > form:nth-child(1) > table:nth-child(29) > tbody > tr:nth-child(4) > td").text
        course_info["prerequisite"] = prereq_1 + "\n" + prereq_2

        syllabus_table = soup.select_one("body > div > div.page > form:nth-child(1) > table:nth-child(39) > tbody")
        syllabus = ""
        max_weeks = 16
